...
class DepartmentsApi(object):
    ...
    def v2_departments_create(self, body, **kwargs):  # noqa: E501
        """v2_departments_create  # noqa: E501

        创建部门  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v2_departments_create(body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.v2_departments_create_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.v2_departments_create_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def v2_departments_create_with_http_info(self, body, **kwargs):  # noqa: E501
        """v2_departments_create  # noqa: E501

        创建部门  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v2_departments_create_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method v2_departments_create" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `v2_departments_create`")  # noqa: E501
        ...
        print(f"C2F5A10 - {body_params}")
        return self.api_client.call_api(
            '/api/v2/departments/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
